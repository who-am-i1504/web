...
export default {
  ...
  meta,
  redirect: {
    name: 'collectRule-index'
  },
  component: layoutHeaderAside,
  children: (pre => [{
      path: 'index',
      name: `${pre}index`,
      component: _import('collect/index'),
      meta: {
        ...meta,
        title: '医疗数据采集'
      }
    },
    {
      path: 'manager',
      name: `${pre}manager`,
      component: _import('collect/manager'),
      meta: {
        ...meta,
        title: '采集数据管理'
      }
    },
    {
      path: 'position',
      name: `${pre}position`,
      component: _import('collect/position'),
      meta: {
        ...meta,
        // cache:true,
        title: 'IP地址定位'
    ...
    },
    {
      path: 'dicom',
      name: `${pre}dicom`,
      component: _import('collect/dicom'),
      meta: {
        ...meta,
        title: 'DICOM采集数据管理'
      }
    },
    {
      path: 'astm',
      name: `${pre}astm`,
      component: _import('collect/astm'),
      meta: {
        ...meta,
        title: 'ASTM采集数据管理'
      }
