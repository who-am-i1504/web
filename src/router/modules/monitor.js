...
export default {
  ...
  children: (pre => [{
    ...
    },
    {
      path: 'rule',
      name: `${pre}rule`,
      component: _import('monitor/rule'),
      meta: {
        ...meta,
        title:'监测黑名单'
      }
    },
    {
      path: 'port',
      name: `${pre}port`,
      component: _import('monitor/port_find'),
      meta: {
        ...meta,
        title:'端口主动发现'
      }
    ...
    },
    {
      path: 'dicom',
      name: `${pre}dicom`,
      component: _import('monitor/dicom'),
      meta: {
        ...meta,
        title:'DICOM传输监测'
      }
    },
    {
      path: 'astm',
      name: `${pre}astm`,
      component: _import('monitor/astm'),
      meta: {
        ...meta,
        title:'ASTM传输监测'
      }
