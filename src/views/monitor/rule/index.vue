        ...
        <div style="margin: -16px; background-color:rgba(#000, .7);">
          <el-form
            ...
            <el-form-item style="background-color: rgba(#000, .7);">
              <el-input style="background-color: rgba(#000, .7);" v-model="inputStr" placeholder="IP地址" size="small"></el-input>
            </el-form-item>
...
<script>
import { getMonitorRule, addMonitorRule, updateMonitorRule, deleteMonitorRule } from '@api/monitor'
import Vue from 'vue'
...
export default {
  ...
  methods: {
    ...
    dealDialogTable(){
      for (var x = this.table.index; x < this.table.index + 100 && x < this.table.mid_data.length; x ++){
